...
function MainLayout() {
    ...
    const isActive = (path: string) => {
        return location.pathname === path
            ? "bg-blue-50 text-blue-600 border-1-4 border-blue-600"
    ...
    return (
        <div className="flex h-screen">
            <aside className="w-56 bg-white border-r border-gray-200 flex flex-col">
                <div className="p-5">
                    <h1 className="text-xl font-bold text-blue-600">Pediatric App</h1>
                </div>
                ...
                <div className="border-t border-gray-200 p-4">
                    ...
                    <div className="flex items-center gap-3 px-2 py-2">
                        <div className="w-8 h-8 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center text-[11px] font-bold">AG</div>
